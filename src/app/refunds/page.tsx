...
export const metadata: Metadata = {
  ...
  description:
    "Learn about our refund policy for credit purchases and when refunds are available.",
};
        ...
        <div className="container relative mx-auto px-6 py-16 max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/90 leading-relaxed">
              We strive for complete customer satisfaction. This policy outlines
              our refund process for digital credits and AI-powered insights.
            </p>
        ...
        <div className="space-y-8">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">
                      Digital credits are generally{" "}
                      <strong>non-refundable</strong> once purchased, as they
                      are immediately available for use. However, we offer
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-4 bg-green-50 rounded-xl p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        You were charged multiple times for a single purchase,
                        or credits were not added to your account after
                        successful payment
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 bg-green-50 rounded-xl p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        AI insight generation failed due to technical issues on
                        our end, and credits were deducted without providing the
                        insights
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 bg-green-50 rounded-xl p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        You purchased credits by mistake and haven't used any of
                        them. Request must be made within 24 hours of purchase.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 bg-green-50 rounded-xl p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Extended service downtime (more than 48 hours) prevented
                        you from using purchased credits
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-4 bg-red-50 rounded-xl p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        You've already spent the credits to generate insights
                        (even partially)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 bg-red-50 rounded-xl p-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 text-sm mb-1">
                        Dissatisfaction with AI Insights
                      </h4>
                      <p className="text-sm text-gray-600">
                        You're unhappy with the quality or accuracy of
                        AI-generated insights. (See our{" "}
                        <Link
                          href="/terms#ai-disclaimer"
                  ...
                  <div className="flex items-start gap-4 bg-red-50 rounded-xl p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        You no longer want the credits after the 24-hour
                  ...
                  <div className="flex items-start gap-4 bg-red-50 rounded-xl p-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 text-sm mb-1">
                        Account Termination (Your Violation)
                      </h4>
                      <p className="text-sm text-gray-600">
                        Your account was suspended or terminated for violating
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              <p className="text-gray-600">
                If you encounter an error while generating insights and your
              ...
              <div className="bg-primary-light rounded-xl p-5">
                ...
                <p className="text-sm text-gray-600 mb-3">
                  In most cases, credits are automatically restored to your
                  account within 10 minutes if the AI processing fails.
                </p>
                <p className="text-sm text-gray-600">
                  If this doesn't happen, please contact support with your chat
                  ID and we'll investigate immediately.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-xl p-5">
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm">
                    Technical Failures (Our Fault)
                  </h4>
                  <p className="text-sm text-gray-600 mb-2">
                    Full credit refund or restoration
                  </p>
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm">
                    User-Side Issues (Not Our Fault)
                  </h4>
                  <p className="text-sm text-gray-600 mb-2">
                    Credit restoration on case-by-case basis
                  </p>
                  <ul className="space-y-1 text-xs text-gray-500">
                    <li className="flex items-start gap-2">
                      <span className="w-1 h-1 rounded-full bg-gray-400 mt-1 flex-shrink-0" />
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <div className="bg-gray-50 rounded-xl p-5">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      You purchased a large credit package (250+ credits)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-primary-light flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      You have a legitimate reason (e.g., platform doesn't
                      support your chat format, medical emergency)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-primary-light flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <p className="text-sm">
                Partial refunds are calculated based on unused credits minus a
                processing fee. Each case is reviewed individually.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-primary">
                  ...
                  <p className="text-xs text-gray-500">
                    We review your refund request and verify eligibility
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-primary">
                  ...
                  <p className="text-xs text-gray-500">
                    Your bank or card issuer reflects the refund (varies by
                    institution)
                  </p>
                </div>
              </div>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-5 rounded-r-xl">
                <p className="text-sm text-gray-700">
                  <strong className="text-blue-700">Note:</strong> Total time
                  from refund approval to money in your account is typically
                  3-15 business days, depending on your payment method and
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 mb-2">
                      Please Don't File Chargebacks Without Contacting Us First
                    </p>
                    <p className="text-sm text-gray-700">
                      Chargebacks hurt small businesses and often result in
                      additional fees. We're committed to resolving issues
                      fairly and quickly.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-3 text-gray-600">
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  ...
                  <p className="text-sm">
                    If a chargeback is filed, we'll provide evidence to your
                    bank showing proof of service delivery (transaction records,
                    account activity logs, insights generated).
                  </p>
                </div>

                <div className="bg-gray-50 rounded-xl p-5">
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm">
                    3. Consequences of Fraudulent Chargebacks
                  </h4>
                  <p className="text-sm">
                    Chargebacks filed for services that were properly delivered
                    may result in permanent account suspension and potential
              ...
              <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded-r-xl">
                <p className="text-sm text-gray-700">
                  ...
                  We understand chargebacks may be necessary for unauthorized
                  transactions or fraud. In such cases, please still notify us
                  so we can investigate and improve security.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                <strong className="text-gray-900">No Subscriptions:</strong>{" "}
                RelivChats operates on a pay-as-you-go credit system. There are
                no recurring subscriptions or memberships to cancel.
              </p>
              ...
              <div className="bg-gray-50 rounded-xl p-5">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      All your chat data and insights will be permanently
                  ...
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-gray-400 mt-1.5 flex-shrink-0" />
                    <span>
                      Transaction history retained for legal/tax purposes (7
                      years)
                    </span>
                  </li>
                </ul>
