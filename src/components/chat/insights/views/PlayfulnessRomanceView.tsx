    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
        ...
        <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
          ...
          <p className="text-sm text-gray-800">
            {content.humor_styles.initiator}
          </p>
        </div>
      </div>

      {/* 4. Inside Jokes */}
      {content.inside_jokes.length > 0 && (
        <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
          <div className="flex items-center gap-2 mb-4">
      ...
      <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
        ...
        <div className="p-4 bg-purple-50 rounded-lg border border-purple-200 mb-4">
          ...
          <p className="text-sm text-gray-800">{content.flirtation.balance}</p>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {content.flirtation.evidence.map((ev, idx) => (
                <div
                  key={idx}
                  className="bg-linear-to-br from-pink-50 to-red-50 rounded-lg p-3 border border-pink-200"
                >
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs font-semibold text-gray-700 uppercase">
              {content.teasing_banter.present ? "Banter Present" : "No Teasing"}
            </p>
          </div>
          ...
          <p className="text-xs text-gray-600">
            ...
            <span className="font-medium">
              {content.teasing_banter.balance}
            </span>
          </p>
        </div>
      ...
      <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
        ...
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 mb-4">
          ...
          <p className="text-xs text-gray-600">
            Initiator:{" "}
            <span className="font-medium">{content.spontaneity.initiator}</span>
          </p>
        </div>
      ...
      <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
            ...
            <p className="text-sm text-gray-800">
              {content.emoji_usage.description}
            </p>
          </div>
          ...
          <div className="p-4 bg-pink-50 rounded-lg border border-pink-200">
            ...
            <p className="text-sm font-medium text-gray-900 capitalize">
              {content.emoji_usage.match_level}
            </p>
          </div>
        </div>
      </div>
      ...
      {/* 9. Fun Activities */}
      {content.fun_activities.discussed && (
        <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
          <div className="flex items-center gap-2 mb-4">
            <Sparkles className={`w-4 h-4 md:w-5 md:h-5 ${theme.text}`} />
            <h4 className="font-bold text-base md:text-lg lg:text-xl text-gray-900">
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs font-semibold text-pink-700 uppercase">
              ...
              <span className="capitalize">
                {content.romance_maintenance.rating}
              </span>
            </p>
          </div>
          <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
      ...
      {/* 12. Playfulness Gaps */}
      {content.playfulness_gaps.length > 0 && (
        <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
          <div className="flex items-center gap-2 mb-4">
          ...
          {content.recommendations.map((rec, idx) => (
            ...
            >
              <div className="flex items-start gap-3 mb-4">
                ...
                >
                  <Sparkles className={`w-5 h-5 md:w-6 md:h-6 ${theme.text}`} />
                </div>
                <div className="flex-1">
                  <h5 className="font-bold text-base md:text-lg text-gray-900 mb-2">
                    {rec.title}
