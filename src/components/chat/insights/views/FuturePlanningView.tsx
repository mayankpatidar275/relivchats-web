    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
        ...
        <div className="flex items-center justify-center mb-4">
          <AlignmentBadge status={content.alignment.overall_level} size="md" />
        </div>
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600">
                    Style:{" "}
                    <span className="font-medium capitalize">{p.style}</span>
                  </p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
            ...
            <p className="text-sm text-gray-800">
              {content.planning_styles.compatibility}
            </p>
          </div>
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <p className="text-sm font-medium text-gray-900">
              {content.planning_styles.initiator}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl p-4 md:p-6 border-2 border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-gray-800">
              {content.timelines.concrete_vs_vague}
            </p>
          </div>
