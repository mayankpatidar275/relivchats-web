...
import { ArrowRight, FileText, Lock, Shield, Upload, Zap } from "lucide-react";
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Get started in seconds. Upload your chat export and receive
              instant basic statistics for free.
            </p>
          </div>
