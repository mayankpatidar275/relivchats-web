...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Reliv Chats collects, uses, and protects your personal information. GDPR and CCPA compliant privacy practices.",
};
        ...
        <div className="container relative mx-auto px-6 py-16 max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/90 leading-relaxed">
              Your privacy is critically important to us. This policy explains
          ...
          <div className="lg:col-span-3 space-y-12">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Name and Email:</strong> Collected when you
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                      <span>
                        <strong>Chat Files:</strong> WhatsApp chat exports you
                        upload for analysis
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                      <span>
                        <strong>Message Content:</strong> Text messages,
                        timestamps, participant names, and emojis from your
                        chats
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                      <span>
                        <strong>Metadata:</strong> Chat statistics (message
                        count, word count, date ranges)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                      <span>
                        <strong>Billing Details:</strong> Name, email, and
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                      <span>
                        <strong>Transaction Data:</strong> Purchase history and
                        credit balance (payment card data is processed by
                        Razorpay/Stripe and never stored on our servers)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                      <span>
                        <strong>Analytics:</strong> Pages visited, features
                        used, time spent on platform
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-xl p-5">
                  ...
                  <p className="text-gray-600 text-sm">
                    Process your chat uploads, generate statistics, and create
                    AI-powered insights based on your selected category
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  ...
                  <p className="text-gray-600 text-sm">
                    Maintain your account, process payments, manage credit
                    balance, and provide customer support
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  ...
                  <p className="text-gray-600 text-sm">
                    Analyze usage patterns to improve our AI models, user
                    experience, and feature development (anonymized data only)
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  ...
                  <p className="text-gray-600 text-sm">
                    Send important service updates, payment confirmations, and
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-gray-600 mb-2">
                    We use Google's Gemini AI to generate relationship insights
                    from your chat data. Your messages are:
                  </p>
                  <ul className="space-y-1 text-sm text-gray-600">
                    <li className="flex items-start gap-2">
                      <span className="w-1 h-1 rounded-full bg-gray-400 mt-2 flex-shrink-0" />
                      <span>
                        Processed through Google's secure API with
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-1 h-1 rounded-full bg-gray-400 mt-2 flex-shrink-0" />
                      <span>
                        Not used to train Google's AI models (contractual
                        guarantee)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-gray-600 mb-2">
                    Your chat messages are stored as vectors in Qdrant for
                  ...
                  <ul className="space-y-1 text-sm text-gray-600">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-1 h-1 rounded-full bg-gray-400 mt-2 flex-shrink-0" />
                      <span>
                        Used only for providing personalized insights to you
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1 h-1 rounded-full bg-gray-400 mt-2 flex-shrink-0" />
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-gray-600 mb-2">
                    Account authentication is managed by Clerk with SOC 2 Type
                    II compliance
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-gray-600 mb-2">
                    Razorpay and Stripe handle all payment processing. They
                    receive necessary billing information but never have access
                    to your chat data
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Hosted on enterprise cloud providers with 99.9% uptime SLA
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4">
                    <h4 className="font-semibold text-gray-900 mb-2 text-sm">
              ...
              <div className="space-y-4 text-gray-600">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Chats that haven't been accessed for 90 days are
                      automatically archived and deleted unless you're an active
                      subscriber
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      ...
                      deleted within 30 days (except legally required
                      transaction records)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Payment and invoice data retained for 7 years for tax and
                      legal compliance
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-primary">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Download all your personal data in JSON format from your
                        account settings
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-primary">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Correct inaccurate personal information in your profile
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-primary">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Limit how we use your data while maintaining your
                        account
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-primary">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Opt-out of marketing communications and non-essential
                        data processing
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-primary">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Transfer your data to another service in
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                ...
                and improve your experience. See our detailed{" "}
                <Link
                  href="/cookies"
                  className="text-primary hover:underline font-semibold"
                >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 bg-gray-50 rounded-lg p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Help us understand how you use the platform (you can
                      opt-out)
                    </p>
                  </div>
                </div>
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                ...
                We only share data with service providers necessary to operate
                our platform:
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Google (AI processing), Qdrant (vector storage), Clerk
                    (authentication), Razorpay/Stripe (payments)
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    In event of merger, acquisition, or sale of assets (you'll
            ...
            >
              ...
              <p className="text-gray-600">
                ...
                children. If you're a parent or guardian and believe your child
            ...
            >
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0" />
                  <span>
                    Posting the new policy on this page with an updated "Last
                    Updated" date
                  </span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <section
              id="contact"
              className="bg-linear-to-br from-primary to-primary-hover rounded-2xl p-8 text-white"
            >
